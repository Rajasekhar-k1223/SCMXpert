                ...
                <ul>
                    ...
                    <li class="dropdown"><a href="#" data-toggle="dropdown">Devices</a>
					          <ul class="dropdown-menu" style="border:0px solid;margin-top:15px;padding:0px 2px;">
					            <li class="bg-color btn-head w-100" style="border-radius:0px 5px  0px 0px;" id="inuse" onclick="javascript:inuse();">In Use Devices</li>
	                    		<li class="bg-color btn-head w-100" id="available"  onclick="javascript:Avaliable();">Available (Transfer Device)</li>
	                    		<li class="bg-color btn-head w-100" id="available"  onclick="javascript:Received();">Received Device</li>
	                    		<li class="bg-color btn-head w-100" id="configure" style="border-radius:0px 0px  5px 5px;" onclick="javascript:configdevices();">Configure</li>
					          </ul></li>
