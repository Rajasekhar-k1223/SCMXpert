...
#deviceAvalibletable>thead>tr>th{padding:4px;text-align:center;}
 ...
 <div class="container">
  	...
  	<div class="row">
  		<div class="col-sm-12 col-lg-5 col-md-5"  style="border: 1px solid #000;padding: 1%;border-radius: 3px">
  			<div style="width: 100%;height: 30px;font-size: 12px;"><span class="w-50 p-1 font-weight-bold float-left text-right" style="line-height: 15px;">Customer Name :</span><span class="float-left" style="width:50%;"><input type="text" class="form-control" placeholder="Number of devices" style="height:25px;font-size: 12px; " id="Cust_Id"/></span></div> 
  			<div style="width: 100%;height: 30px;font-size: 12px;"><span class="w-50 p-1 font-weight-bold float-left text-right" style="line-height: 15px;">Partner :</span><span class="float-left" style="width:50%;"><input type="text" class="form-control" placeholder="Number of devices" style="height:25px;font-size: 12px; " id="bp_name"/></span></div> 
...
<table class="table table-striped table-bordered p-0" id="deviceAvalibletable" style="font-size:11px;overflow-x:auto;">
 ...
 <!-- 		<tr>
	...
	<!-- 		<button class="btn btn-color m-1">Save as Draft</button>
			...
			<button class="bg-color margin-rl1 btn-head" id="createDevice" onclick="javascript:createDevice();">Edit / Create Transfer Device</button>
			<button class="bg-color margin-rl1 btn-head" id="deviceReceipt" onclick="javascript:deviceRecipt();">Device Transfer Receipt</button>
